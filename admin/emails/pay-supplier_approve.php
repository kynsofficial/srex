...
<title>Pay Supplier Order</title>
<meta name='description' content='Pay Supplier Order.'>
<style type='text/css'>
...
<h1 style='color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;'>Pay Supplier Order Notification</h1>
<span
style='display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;'></span>
<p style='color:#455056; font-size:15px;line-height:24px; margin:0;'>
Hello, this is to confirm that your Pay Supplier's Order payment with ID ".$ref_id." has been successfully approved, and your order
will be in process. You would get another notification if the order has been processed. Login to your dashboard to learn more.
<br>Summary of the Order is show below:
</p>
<hr>
<table cellspacing='10' border='0' cellpadding='5' width='100%' bgcolor='#f2f3f8'>
  <tr>
    <th style='text-align: left !important'>Suppplier Name</th>
    <td style='text-align: right !important'>".$row['supplier_name']."</td>
  </tr>
  <tr>
    <th style='text-align: left !important'>Suppplier Phone</th>
    <td style='text-align: right !important'>".$row['supplier_phone']."</td>
  </tr>
  <tr>
    <th style='text-align: left !important'>Supplier Email</th>
    <td style='text-align: right !important'>".$row['supplier_email']."</td>
  </tr>
  <tr>
    <th style='text-align: left !important'>Bank Details</th>
    <td style='text-align: right !important'>".$row['supplier_bank_account']."</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style='text-align: right !important'><span style='color: green'>Payment Successfull</span></td>
  </tr>
</table>
<hr>
<p style='font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;'>
  Your Order shall begin processing upon verification.
</p>
...
try {
  ...
  //Recipients
  // $mail->addAddress($settings['admin_email'], 'Pay Supplier Order');
  $mail->addAddress($iow['email']);
  $mail->addReplyTo($email_reply, $settings['site_name']);

  //Content
  $mail->isHTML(true);
  $mail->Subject = $settings['site_name']." Pay Supplier Order Notification";
  $mail->Body = $message;
