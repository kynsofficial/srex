...
<title>Procurement and Shipping Order</title>
<meta name='description' content='Procurement and Shipping Order.'>
<style type='text/css'>
...
<h1 style='color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;'>Procurement and Shipping Order Notification</h1>
<span
style='display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;'></span>
<p style='color:#455056; font-size:15px;line-height:24px; margin:0;'>
Hello, this is to confirm that your Shippments Order payment with ID ".$ref_id." has been successfully approved, and your order
...
try {
  ...
  //Recipients
  // $mail->addAddress($settings['admin_email'], 'Procurement and Shipping Order');
  $mail->addAddress($iow['email']);
  $mail->addReplyTo($email_reply, $settings['site_name']);

  //Content
  $mail->isHTML(true);
  $mail->Subject = $settings['site_name']." Procurement and Shipping Order Notification";
  $mail->Body = $message;
