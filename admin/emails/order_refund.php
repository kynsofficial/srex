...
Hello, this is to notify you that your Shippments Order payment transaction with ID ".$row['ref_id']." was refunded, reason being that ".$reason.". Kindly confirm the status of this transaction.
</p>
