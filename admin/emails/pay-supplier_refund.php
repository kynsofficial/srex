...
Hello, this is to notify you that your Pay Supplier Order payment transaction with ID ".$row['ref_id']." was refunded, Kindly confirm the status of this transaction.
</p>
