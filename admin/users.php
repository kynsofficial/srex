        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <?php
              ...
              $stmt1 = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE type=0 AND status=0 OR status=2");
              $stmt1->execute();
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                      <div class="content-left">
                        ...
                        <small>Pending/Suspended Users</small>
                      </div>
              ...
              <div class="card-datatable table-responsive text-nowrap">
                <table class="datatables-users table border-top" id="example1">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    $conn = $pdo->open();
                    try{
                      $stmt = $conn->prepare("SELECT * FROM users WHERE type = 0 ORDER BY date_created DESC");
                      $stmt->execute();
                      $i = 0;
                      foreach($stmt as $row){
                        // $i++;
                        ...
                        elseif ($row['google_id'] !== "") {
                          $img = '
                            <img src="'.$row['photo'].'" alt="user-avatar" class="d-block rounded m-2" height="50" loading="lazy" width="50" id="uploadedAvatar" />
                          ';
                        }
                        else{
                          $img = '
                            <img src="'.$settings['site_url'].'assets/img/avatars/'.$row['photo'].'" alt="user-avatar" loading="lazy" class="d-block rounded m-2" height="50" width="50" id="uploadedAvatar" />
                          ';
                        }
                        if ($row['firstname'] == "") {
                          $name = $row['username'];
                        ...
                        <tr>
                          <td>".$i."</td>
                          <td><a href='user-details?userid=".$row['id']."'>".$img."</a></td>
                          <td><a href='user-details?userid=".$row['id']."'>".$name."</a></td>
                          <td>".$row['email']."</td>
                          <td>".$settings['currency'].number_format($row['balance'], 2)."</td>
                          <td>".$status." ".$active."</td>
                          ...
                          <td>
                            <div class='dropdown'>
                              ...
                              <div class='dropdown-menu'>
                                <a class='dropdown-item' href='user-details?userid=".$row['id']."'><i class='bx bx-show me-1'></i> View Details</a>
