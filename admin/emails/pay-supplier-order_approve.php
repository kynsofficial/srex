...
Hello, this is to confirm that your Pay Supplier's Order with ID ".$ref_id." has been successfull, and your a total of ¥".$row['amount']." has been sent to ".$row['supplier_name'].". Kindly confirm the status of this transactions with your supplier.
...
<table cellspacing='10' border='0' cellpadding='5' width='100%' bgcolor='#f2f3f8'>
  ...
  <tr>
    ...
    <td style='text-align: right !important'><span style='color: green'>Completed</span></td>
  </tr>
</table>
<hr>
