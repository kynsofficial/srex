        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Manage /</span> Admins
            </h4>


            <?php
              $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE type=1 AND status=1");
              $stmt->execute();
              ...
              $stmt1 = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE type=1 AND status=0 OR status=2");
              $stmt1->execute();
              ...
              $stmt1 = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE type=1");
              $stmt1->execute();
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title">All Admins List</h5>
              ...
              <div class="card-datatable table-responsive text-nowrap">
                <table class="datatables-users table border-top" id="example1">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    $conn = $pdo->open();
                    try{
                      $stmt = $conn->prepare("SELECT * FROM users WHERE type = 1 AND id!=:id ORDER BY id DESC");
                          ...
                          <td>
                            <div class='dropdown'>
                              ...
                              <div class='dropdown-menu'>
                                <a class='dropdown-item' href='admin-details?userid=".$row['id']."'><i class='bx bx-show me-1'></i> View Details</a>
