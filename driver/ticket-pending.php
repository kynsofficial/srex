        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Misc /</span> Pending Tickets
            </h4>
              <div class="row">
                <div class="col-12">
                ...
                <div class="col-12 mb-4 mb-md-0">
                  <div class="card">
                    <h4 class="card-header">Pending Tickets List</h4>
                    <div class="card-datatable table-responsive text-nowrap">
                      <table class="table border-top" id="example1">
                        ...
                        <tbody class="table-border-bottom-0">
                          ...
                          try{
                            $stmt = $conn->prepare("SELECT * FROM tbl_tickets WHERE resolved = 0 ORDER BY id DESC");
                            $stmt->execute();
                            $i = 0;
                            foreach($stmt as $row){
                              if ($row['resolved'] == 0) {
