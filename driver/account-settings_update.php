<?php
	...
	if(isset($_POST['save'])){
		...
		if($gender == "Male" OR $gender == "Female"){
			...
			try{
				$stmt = $conn->prepare("UPDATE drivers SET gender=:gender, dob=:dob, address=:address, firstname=:firstname, lastname=:lastname, contact_info=:contact_info WHERE id=:id");
