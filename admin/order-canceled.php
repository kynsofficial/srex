        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Services / Shippments / </span> Cancelled Orders
            </h4>
              ...
              <div class="card-datatable table-responsive text-nowrap">
                <table class="datatables-users table border-top" id="example1">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    $conn = $pdo->open();
                    try{
                      $stmt = $conn->prepare("SELECT * FROM orders WHERE status = 4 ORDER BY date_created DESC");
                      $stmt->execute();
                      $i = 0;
                      foreach($stmt as $row){
                        if ($row['status'] == 0) {
