...
<body onload="onLoaded()">
  ...
  <div class="invoice-print p-4" id="myInvoice">
    ...
    <!-- Core JS -->
      ...
      function onLoaded() {
        ...
        //   width: 1366
        // }).then(canvas => {
        //   const imageOld = canvas.toDataURL();
          ...
          // window.location.assign(imageOld);
          pdfMake.createPdf(docDefinition).download("Receipt Pay Supplier <?php echo $details['ref_id']; ?>.pdf");
